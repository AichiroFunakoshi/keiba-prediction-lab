...
ロードマップの段階1、3、4、8を完了し、段階2の実データ源監査、段階5の初期モデル、段階6の三連単評価、段階7のウォークフォワード検証を進めています。実購入候補は三連単1点100円に限定し、1・3・5・10点は購入しない影の評価として分離します。実データ源は未承認のため、テストには合成データだけを使用します。
