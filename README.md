...
ロードマップの段階1、3、4を完了し、段階2の実データ源監査と段階5の初期モデル開発を進めています。監査・未来情報ゲート・比較用ベースライン・時点整合的な特徴量生成器に加え、レース内の勝率と3着内率を出力する条件付きロジットモデルを収録しています。実データ源は未承認のため、テストには合成データだけを使用します。
